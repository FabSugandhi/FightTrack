  ...
  return (
    <div className="container mt-5">
      <section className="section">
        <div className="box">
          <h1 className="title is-2">Terms of Service</h1>
          <p className="mt-4">
            Welcome to our website. If you continue to browse and use this website, you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern FightTrack's relationship with you in relation to this website.
          </p>
          <p className="mt-4">
            The term 'FightTrack' or 'us' or 'we' refers to the owner of the website. The term 'you' refers to the user or viewer of our website.
          </p>
          <p className="mt-4">
            These Terms govern your access to and use of FightTrack. Our Services are offered
            ...
            FightTrack Privacy Policy), and procedures that may be published from time to time
            by us.
          ...
          <ol>
            ...
            <li className="mt-4"> Responsibility of Visitors and Users </li>
              <p>
            ...
            <li className="mt-4">Fees, Payment, and Renewal</li>
                <ol type="a">
                  <li>Fees	for	Paid	Services</li>
                    <p>	
                      Some of our Services are offered for a fee. By using a Paid Service, you agree to
                      pay any specified fees associated with specific features. Depending on the Paid Service,
                      ...
                      do at any time by contacting the relevant support team.
                    </p>
                  <li>Payment</li>		
                    <p>
            ...
            <li className="mt-4">General Representation and Warranty</li>
              <p>
                You represent and warrant that your use of our Services will be in strict accordance
                with these Terms:
              </p>
                <ol type="a">
                  <li> will comply with all applicable laws and regulations (including, without
                  ...
                  advertising);</li>
                  <li> will not use the Services for any unlawful purposes, to publish illegal content,
                  or in furtherance of illegal activities;</li>
                  <li> will not infringe or misappropriate the intellectual property rights of any third
                  party;</li>
                  <li> will not overburden our systems, as determined by us in our sole discretion;</li>
                  ...
                  <li> will not be used to create, distribute, or enable material that is - or that
                  facilitates or operates in conjunction with - malware, spyware, adware, or
                  other malicious programs or code.</li>
                </ol>
            <li className="mt-4">Copyright Infringement</li>
              <p>
            ...
            <li className="mt-4">Intellectual Property</li>
              <p>
                The Agreement does not transfer from FightTrack to you any intellectual
                property, and all right, title, and interest in and to such property will remain (as
                between the parties) solely with  FightTrack. Any trademarks, service marks,
                graphics, and logos used in connection with our Services, are trademarks or
                registered trademarks of FightTrack. Other trademarks, service marks,
                ...
                reproduce or otherwise use any  FightTrack or third party trademarks.
              </p>
            <li className="mt-4">Changes</li>
              <p>
          ...
          <li className="mt-4">Jurisdiction and Applicable Law</li>
              <p>
                Except to the extent any applicable law provides otherwise, the Agreement and any
                access to or use of our Services will be governed by the laws of
                FightTrack excluding its conflict of law provisions. The proper venue for
                any disputes arising out of or relating to the Agreement and any access to or use of
                our Services will be the state and federal courts.
              </p>
          <li className="mt-4">Miscellaneous</li>
              <p>
                The Agreement constitutes the entire agreement between  FightTrack and
                ...
                to, and agrees to be bound by, its terms and conditions;  FightTrack may
