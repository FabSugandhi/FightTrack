    ...
    <div className="container mt-5">
      <section className="section">
        <div className="box">
            ...
            <p className="mt-4">
                FightTrack is committed to providing quality services to you and this policy outlines our 
            ...
            <ol>
                <li className="mt-4"> What is Personal Information and why do we collect it? </li>
                <p className>
                ...
                <p>
                    ...
                    by telephone and facsimile, by email, via our website, from your website, from media 
                    and publications, from other publicly available sources, from cookies and from 
                    third parties. We don’t guarantee website links or policy of authorised third parties.
                </p>
                <p>
                    ...
                    for secondary purposes closely related to the primary purpose, in circumstances where you would 
                ...
                <li className="mt-4"> Sensitive Information </li>
                <p>
                    ...
                    record or health information. Sensitive information will be used by us only:
                </p>
                <ol type="i">
                ...
                <li className="mt-4">Third Parties</li>
                <p>	
                ...
                <li className="mt-4">Disclosure of Personal Information</li>
                <p>
                ...
                <li className="mt-4">Security of Personal Information</li>
                <p>
                ...
                <p>
                    ...
                    However, most of the Personal Information is or will be stored in client files which will be 
                    kept by us for a minimum of 7 years.
                </p>
                <li className="mt-4">Access to your Personal Information</li>
                <p>
                ...
                <p>
                    FightTrack will not charge any fee for your access request, but may charge an administrative 
                    fee for providing a copy of your Personal Information.
                </p>
                <p>
                    In order to protect your Personal Information we may require identification from you before releasing the requested information.
                </p>
                <li className="mt-4">Maintaining the Quality of your Personal Information</li>
                <p>
                    It is an important to us that your Personal Information is up to date. We  will  take reasonable steps 
                    to make sure that your Personal Information is accurate, complete and up-to-date. If you find that the 
                    information we have is not up to date or is inaccurate, please advise us as soon as practicable so we can 
                    update our records and ensure we can continue to provide quality services to you.
                </p>
                <li className="mt-4">Policy Updates</li>
                <p>
