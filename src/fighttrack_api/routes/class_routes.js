...
const { createClass, updateClass, deleteClass, getClasses, getClassById, markAttendance, getClassBookings, addAttendee, removeAttendee } = require('../controllers/class_controller.js');
...
router.get('/:id/bookings', verify, isAdmin, getClassBookings);
